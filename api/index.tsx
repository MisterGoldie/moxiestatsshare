      ...
      image: (
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{ marginLeft: 'auto', marginRight: '100px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p style={{ 
                fontSize: '72px', 
                color: 'white', 
              ...
              <p style={{ 
                ...
                FID: {fid} {userInfo && userInfo.farScore !== null && `| Farscore: ${userInfo.farScore.toFixed(2)}`}
              </p>
            </div>
          </div>
          ...
          {errorMessage ? (
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', position: 'absolute', top: '46%', width: '100%' }}>
              <div style={{ width: '40%', textAlign: 'center', margin: '10px' }}>
